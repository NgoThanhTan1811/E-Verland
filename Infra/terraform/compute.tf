  ...
  app_container_definitions = [
    {
      ...
      secrets = [
        ...
        { name = "ConnectionStrings__Redis__Port", valueFrom = "${var.app_secrets_arn}:Redis__Port::" },
        { name = "ConnectionStrings__Redis__Ssl", valueFrom = "${var.app_secrets_arn}:Redis__Ssl::" },
        { name = "ConnectionStrings__Redis__AbortConnect", valueFrom = "${var.app_secrets_arn}:Redis__AbortConnect::" },
        { name = "ConnectionStrings__Redis__User", valueFrom = "${var.app_secrets_arn}:Redis__User::" },
